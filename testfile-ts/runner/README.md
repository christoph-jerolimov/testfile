...
Full documentation:
[testfile-dev.github.io](https://testfile-dev.github.io/) —
in particular [Getting started](https://testfile-dev.github.io/docs/getting-started)
and [CLI & TUI](https://testfile-dev.github.io/docs/cli).
